...
var getDistance = function (polar1, polar2) {
    var _a = toCart.apply(void 0, polar1), x1 = _a[0], y1 = _a[1], z1 = _a[2];
    var _b = toCart.apply(void 0, polar2), x2 = _b[0], y2 = _b[1], z2 = _b[2];
...
var findTrackpoint = function (image, points, start, end) {
    ...
    if (end === void 0) { end = points.length - 1; }
...
var getD3InputArray = function (gpxString, imageArray) {
    return parseGpxP(gpxString)
        ...
        imageArray.forEach(function (image) {
            ...
            for (var i = pointIdx + 1; i < Math.min(pointIdx + spreadScale, inputArray.length); i++) {
