...
router.get('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, gpxBatches, gpxString, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                gpxBatches = _a.sent();
                gpxString = gpxBatches.reduce(function (accum, entry) {
...
router.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, string, id, seq, location_1, gpxEntry, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, string = _a.string, id = _a.id, seq = _a.seq, location_1 = _a.location;
