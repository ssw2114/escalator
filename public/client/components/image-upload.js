...
var ImageUpload = /** @class */ (function(_super) {
  ...
  ImageUpload.prototype.render = function() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'select',
        {value: this.state.offset, onChange: this.zoneChange},
        offsets.map(function(offset, idx) {
          return offset === 'UTC'
            ? React.createElement('option', {key: idx, value: 'Z'}, offset)
            : React.createElement('option', {key: idx, value: offset}, offset)
        })
      ),
...
var mapDispatch = function(dispatch) {
  return {
    loadImages: function(data, offset) {
      return dispatch(loadImagesThunk(data, offset))
    }
  }
}
