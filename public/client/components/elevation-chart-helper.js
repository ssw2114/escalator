...
var drawGraph = function (gpxString, images) {
    getD3InputArray(gpxString, images)
        ...
        var _a = data.reduce(function (accum, curr) {
            ...
            return accum;
        }, [10000, 0]), elevationMin = _a[0], elevationMax = _a[1];
        ...
        data.forEach(function (point) {
            if (point.startImageCluster) {
                lineSvg
                    ...
                    .attr('transform', 'translate(' + x(point.distance) + ',' + y(point.elevation) + ')') // set y position of bottom of text
                    .attr('dy', '.35em')
        ...
        function mousemove() {
            ...
            if (d.imageUrl) {
                ...
                focus
                    ...
                    .attr('y1', 0)
                    .attr('y2', height)
                    .attr('transform', 'translate(' + x(d.distance) + ',' + y(d.elevation) + ')')
