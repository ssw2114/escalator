...
1.  `npm install`
2.  This app uploads photos to Cloudinary, so you'll need API credentials. (See https://cloudinary.com/documentation/image_upload_api_reference.) Add these to your secrets.js file.
3.  `npm run start-dev`

### Deployment to Heroku

1.  Add a git remote for Heroku
2.  This app uploads photos to Cloudinary, so you'll need API credentials. (See https://cloudinary.com/documentation/image_upload_api_reference.) Add these credentials as Config Vars in your Heroku app.
